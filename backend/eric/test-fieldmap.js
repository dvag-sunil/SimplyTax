...
check('total mapped fields = 264 (was 255 - +9 for the real "sonstige Vorsorgeaufwendungen" category, found by actually opening a sibling element identified earlier but never checked - covers accident/liability/term-life, disability, and endowment life insurance)', Object.values({
  ESt1A: fm.ESt1A, N: fm.N, VOR: fm.VOR, SA: fm.SA, Kind: fm.Kind, N_DHH: fm.N_DHH,
...
}).reduce((sum, o) => sum + Object.keys(o).length, 0) === 264);
