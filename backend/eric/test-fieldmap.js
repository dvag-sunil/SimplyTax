...
check('total mapped fields = 269 (was 267 - +2 for the itemized Werbungskosten description and amount fields, confirmed genuinely required alongside the sum via a real ERiC rejection)', Object.values({
  ESt1A: fm.ESt1A, N: fm.N, VOR: fm.VOR, SA: fm.SA, Kind: fm.Kind, N_DHH: fm.N_DHH,
...
}).reduce((sum, o) => sum + Object.keys(o).length, 0) === 269);
