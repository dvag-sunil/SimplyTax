...
check('total mapped fields = 285 (was 284 - +1 for spouseReligion, a genuine real ERiC rejection during joint assessment)', Object.values({
  ESt1A: fm.ESt1A, N: fm.N, VOR: fm.VOR, SA: fm.SA, Kind: fm.Kind, N_DHH: fm.N_DHH,
...
}).reduce((sum, o) => sum + Object.keys(o).length, 0) === 285);
