...
check('total mapped fields = 274 (was 269 - +5 for the DHH date/reason/workplace/own-household/travel-mode fields, confirmed genuinely required alongside the amounts via a real ERiC rejection)', Object.values({
  ESt1A: fm.ESt1A, N: fm.N, VOR: fm.VOR, SA: fm.SA, Kind: fm.Kind, N_DHH: fm.N_DHH,
...
}).reduce((sum, o) => sum + Object.keys(o).length, 0) === 274);
